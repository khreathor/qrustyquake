...
s32 WIPX_Read(sys_socket_t socketid, byte *buf, s32 len, struct qsockaddr *addr);
s32 WIPX_Write(sys_socket_t socketid, byte *buf, s32 len, struct qsockaddr *addr);
s32 WIPX_Broadcast(sys_socket_t socketid, byte *buf, s32 len);
